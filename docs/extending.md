...
Если вместо специализированной модели нужен просто heap-alloc-free конвейер с известным на этапе компиляции набором правил — для этого уже есть готовый `vd::static_model<T, Rules...>`, писать свой тип не требуется. См. [static-model.md](static-model.md).
